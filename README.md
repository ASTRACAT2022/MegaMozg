...
- `MEZA_TERMINAL_SSH_ENABLED`
- `MEZA_TERMINAL_SSH_USER`
- `MEZA_TERMINAL_SSH_PORT`
- `MEZA_TERMINAL_SSH_KEY_PATH`
- `MEZA_TERMINAL_SSH_STRICT_HOST_KEY_CHECKING`
- `MEZA_TERMINAL_SSH_KNOWN_HOSTS_PATH`
- `MEZA_GEMINI_API_KEY`
- `MEZA_GEMINI_MODEL`
...
- `MEZA_PANEL_TLS_HOST`
- `MEZA_PANEL_BASIC_AUTH_ENABLED`
- `MEZA_PANEL_BASIC_AUTH_USER`
- `MEZA_PANEL_BASIC_AUTH_PASSWORD`
- `MEZA_PANEL_BASIC_AUTH_SESSION_TOKEN`
...
Real SSH terminal mode in panel can be configured via `.env`:
